<div>
    <flux:breadcrumbs>
        ...
        <flux:breadcrumbs.item :href="route('admin.current-years.index')" wire:navigate>Denominación Año Actual
    ...
    <div class="flex-1 self-stretch max-md:pt-6">
        <form wire:submit.prevent='save' class="my-6 w-full space-y-6">
            ...
            <div class="mt-5 w-full max-w-lg flex flex-col gap-4 mb-4">
                <flux:textarea wire:model.defer="form.denominacion" label="Denominación año" rows="2"
                    placeholder="Ej. Año del bicentenario...">
                    {{ old('denominacion') }}
                </flux:textarea>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <flux:button :href="route('admin.current-years.index')" wire:navigate>Cancelar </flux:button>
            </div>
        </form>
    </div>
